...
//    @Headers("Static-Header:123")    /*For single Static header*/
    @Headers({"Static-Header:123","Static-Header2:456"})   /*For multiple Static Header*/
    @PUT("posts/{id}")
    Call<Post> putPost(@Header ("Dynamic-Header") String header,  /*For Dynamic Header*/
                       @Path("id") int id,
                       @Body Post post);
}
